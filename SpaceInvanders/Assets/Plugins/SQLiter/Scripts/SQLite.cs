...
namespace SQLiter
{
    ...
    public class SQLite : MonoBehaviour
    {
        ...
        public void InsertPlayer(string name, int raceType, int classType, int gold, int login, int level, int xp)
        {
            ...
            mSQLString = string.Format ("INSERT OR REPLACE INTO {0} ({1},{2},{3},{4},{5},{6},{7}) VALUES ('{8}',{9},{10},{11},{12},{13},{14});", 
			                            SQL_TABLE_NAME, COL_NAME, COL_RACE, COL_CLASS, COL_GOLD, COL_LOGIN_LAST, COL_LEVEL, COL_XP, name, raceType, classType, gold, login, level, xp);
